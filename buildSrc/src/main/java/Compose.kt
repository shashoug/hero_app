object Compose {
    ...
    const val materailThree = "androidx.compose.material3:material3:1.1.0"
    const val materialWindoSize = "androidx.compose.material3:material3-window-size-class:1.1.0"
