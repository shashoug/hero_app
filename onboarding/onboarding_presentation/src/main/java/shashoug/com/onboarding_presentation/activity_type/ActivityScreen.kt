package shashoug.com.onboarding_presentation.activity_type
        ...
        Column(
            ...
            Row {
                SelectableButton(
                    ...
                    onClick = {
                        viewModel.onLevelClick(ActivityLevel.Low)
                    },
                ...
                SelectableButton(
                    ...
                    selectedTextColor = Color.White,
                    onClick = {
                        viewModel.onLevelClick(ActivityLevel.Medium)
                    },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
                ...
                SelectableButton(
                    ...
                    selectedTextColor = Color.White,
                    onClick = {
                        viewModel.onLevelClick(ActivityLevel.High)
                    },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
